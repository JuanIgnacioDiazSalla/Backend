...
console.log("Segunda llamada a getProducts (verificar que se haya añadido correctamente):");
productManager.getProducts();

console.log("Añadiendo producto repetido:");
productManager.addProduct("Producto Prueba", "Este es un producto de prueba", 200, "Sin imagen", "abc123", 25);

console.log("Tercera llamada a getProducts (verificar que no se haya añadido el producto):");
productManager.getProducts();

console.log("Añadiendo nuevo producto:");
productManager.addProduct("Producto Prueba", "Este es un producto de prueba", 200, "Sin imagen", "codigo_a_modificar", 25);

console.log("Cuarta llamada a getProducts (verificar que se haya añadido correctamente):");
productManager.getProducts();

console.log("Llamada a getProductById (producto existente):");
productManager.getProductById(2);

console.log("Llamada a getProductById (producto inexistente):");
productManager.getProductById(3);

console.log("Llamada a updateProductById:");
productManager.updateProductById(2, "code", "codigo_modificado");

console.log("Llamada a deleteProductById:");
productManager.deleteProductById(1);

console.log("Quinta llamada a getProducts (verificar que se haya eliminado correctamente):");
productManager.getProducts();
